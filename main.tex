...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {International Institute of Information Technology, Naya Raipur}{Aug. '17 -- June '21}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    {\item{
     \textbf{Languages}{: Python, JavaScript, C\#, Java, C} \\
     \vspace{1pt}
     \textbf{Developer Tools}{: Heroku, Git, GitHub, Adobe Illustrator, CI/CD (GitHub Actions) } \\
     \vspace{1pt}
     \textbf{Technologies}{: Node.js, React, Express, Bootstrap, Passport, Django} \\
    }}
 \end{itemize}
 \vspace{-16pt}
