...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \vspace{-7pt}
      \resumeItemListStart
        \resumeItem{Utilized design patterns to improve and introduce new features like black masking for Charts built on WPF}
        \resumeItem{Resolved bugs related to preview area and rendering of Visual Acuity and Chart Layouts in Chart Viewer}
        \resumeItem{Wrote unit tests for ChartViewer and other legacy projects to increase coverage for SonarQube}
