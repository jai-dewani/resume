  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Enhanced click request handling efficiency by introducing a queuing mechanism to the main control request handler, \textbf{reducing click to response time by 40\%}}
        \resumeItem{Spearheaded the development of the Chart Viewer segment, effectively steering its delivery to market for product release}
        ...
        \resumeItem{Improved and \textbf{optimized workflow efficiency by 23\%} via restructuring application response keeping asynchronous design at the center}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Collaborated with cross-functional teams to define and seamlessly integrate API requirements}
