...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \vspace{-7pt}
      \resumeItemListStart
        \resumeItem{Utilized design patterns to improve on various existing Eye charts implementations build using WPF}
        \resumeItem{Resolved bugs related to incorrect preview and rendering of Visual Acuity and Chart Layouts in Chart Viewer}
        \resumeItem{Worked on securing a video streaming service while minimizing computational load on system}
      \resumeItemListEnd
