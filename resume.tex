  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Streamlined development for the whole team to reduce physical device dependency by mocking system endpoints}
        \resumeItem{Worked with to enhance existing in time asynchronous notifications}
        \resumeItem{Resolved bugs related to preview area and rendering of Visual Acuity and Chart Layouts in Chart Viewer}
        \resumeItem{Introduced new features and improved existing bugs like black masking, preview area for Charts built on WPF}
        \resumeItem{Worked with the UI team to optimise usage of chartviewer by making sure only atomic operations are exposed and utilized}
        % \resumeItem{Worked on ensuring video streaming uses https   service while minimizing computational load on system}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \vspace{-7pt}
      \resumeItemListStart
        \resumeItem{Implemented new methods, which were exposed as APIs using .NET framework to be utilised by frontend}
        \resumeItem{Created and deployed new gRPC servers for reducing coupling and introduce IPC channels for various services}
        \resumeItem{Utilized NUnit and Fluent Assertions for writing new unit test cases  improving overall development cycle   }
      \resumeItemListEnd
