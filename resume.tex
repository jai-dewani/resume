  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Worked with SignalR to enhance existing in time asynchronous notifications}
        \resumeItem{Resolved bugs related to preview area and rendering of Visual Acuity and Chart Layouts in Chart Viewer}
        \resumeItem{Utilized design patterns to introduce and implement new features like black masking for Charts built on WPF}
